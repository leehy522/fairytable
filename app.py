...
MENU_MAP = {
    "🏷️ 요정비닐 상품 현황": "views/product_status.py",
    "🚚 밀크런 PPT 변환": "views/milkrun_ppt.py",
    "📦 택배 송장 변환": "views/invoice.py",
    "🏭 원가 시뮬레이터": "views/cost_simulator.py",
    "📈 시장 지표 분석": "views/market_index.py",
    "🏛️ 나라장터 입찰": "views/narajangte.py"
}
