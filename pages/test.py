...
def show_margin_calc():
    st.title("🛡️ 페어리테이블 마진 정밀 시뮬레이터 (V2.1)")
    st.markdown("---")
    ...
    try:
        ...
        edited_output = st.data_editor(
            ...
            hide_index=True, use_container_width=True, key="margin_editor_v2"
        )
        ...
        st.subheader(f"📊 {selected_month} 시뮬레이션 결과")

        # [수정 포인트] applymap 대신 map 사용 (Pandas 2.1+ 대응)
