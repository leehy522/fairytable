...
_COLUMN_MAP = {
    ...
    "받는사람": ["Receiver name", "Receiver Name", "수취인 이름", "받는사람", "수령인", "이름","수령인 이름","수령인명"],
    "전화번호1": ["Mobile", "모바일", "전화번호", "연락처", "휴대폰","수령인 전화번호","수령인 연락처"],
    "우편번호": ["Zip Code", "우편번호", "Zip", "POST","배송 우편번호(다음 우편번호로 발송해야 합니다.)"],
    "상세주소": ["Detailed address", "상세 주소", "상세주소", "주소2", "배송지","배송 주소 1"],
    "상품명": ["Product Information", "제품 정보", "상품명", "품명", "Item","선택 사항","구매 수량","옵션명"],
    "수량1": ["구매 수량","발송할 수량", "수량", "주문수량", "Quantity", "수량(개)","주문건수"] # 💡 수량 매핑 키워드 추가
}
