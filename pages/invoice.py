...
_COLUMN_MAP = {
    "주문번호": ["Order ID", "주문 ID", "주문번호", "No"],
    "받는사람": ["Receiver name", "Receiver Name", "수취인 이름", "받는사람", "수령인", "이름"],
    "전화번호1": ["Mobile", "모바일", "전화번호", "연락처", "휴대폰"],
    "우편번호": ["Zip Code", "우편번호", "Zip", "POST"],
    "상세주소": ["Detailed address", "상세 주소", "상세주소", "주소2", "배송지"],
    "상품명": ["Product Information", "제품 정보", "상품명", "품명", "Item"]
}
